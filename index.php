...
<body data-spy="scroll" data-target="#navbarResponsive">
        ...
        <header>
            ...
            <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
                    ...
                    <div class="collapse navbar-collapse" id="basicExampleNav">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a class="btn btn-danger btn-md" href="aregister.php" target="_blank">Company Sign In</a>
                            </li>
                        </ul>
                        <!-- Links -->
            ...
            <div id="intro" class="view">
                             ...
                             <!--Carousel Wrapper-->
                        <div id="carousel-example-2" class="carousel slide " data-ride="carousel" data-interval="2000">
                                <!--Indicators-->
                                ...
                                <div class="carousel-item active">
                                    <div class="view">
                                    <img class="d-block w-100" src="img/background.png"
                                        alt="First slide">
                ...
                <section id="services" class="text-center">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-5">
                            ...
                            <h4 class="my-4 font-weight-bold">Target Audiance</h4>
                        ...
                        <div class="col-md-4 mb-1">
                            ...
                            <h4 class="my-4 font-weight-bold">Reviews</h4>
                            <p class="grey-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reprehenderit
                                maiores nam,
                                aperiam minima
                                assumenda deleniti hic.</p>
                        ...
                        <div class="col-md-4 mb-1">
                            ...
                            <h4 class="my-4 font-weight-bold">start up benifits</h4>
                            <p class="grey-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reprehenderit
                                maiores nam,
                                aperiam minima
                                assumenda deleniti hic.</p>
                ...
                <section id="team" class="text-center">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-12 mb-4">
                            ...
                            <h4 class="my-4 font-weight-bold">Sandupa</h4>
                            <p class="grey-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reprehenderit
                                maiores nam,
                                aperiam minima
                                assumenda deleniti hic.</p>
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            ...
                            <h4 class="my-4 font-weight-bold">Chris</h4>
                            <p class="grey-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reprehenderit
                                maiores nam,
                                aperiam minima
                                assumenda deleniti hic.</p>
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            ...
                            <h4 class="my-4 font-weight-bold">Jegan</h4>
                            <p class="grey-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reprehenderit
                                maiores nam,
                                aperiam minima
                                assumenda deleniti hic.</p>
        ...
        <div id="contact" class="offset">
              ...
              <div class="container-fluid">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12">
                      <!-- Form contact -->
                    <form id="contactForm" name="contactForm" nonvalidate="nonvalidate">
                      <div class="form-row">
                        <div class="col col-md-6">
                          ...
                          <div class="form-group">  <i class="fa fa-envelope prefix"></i>
                          ...
                          <div class="form-group"> <i class="fa fa-tag prefix"></i>
                            <input class="form-control" type="tel" placeholder="Your Phone *" required/>
                            <small class="form-text text-danger help-block lead"></small>
                          </div>
                        </div>
                          <div class="col-md-6">
                            <div class="form-group"> <i class="fa fa-pencil prefix"></i>
                          ...
                          <div class="col-lg-12 text-center">
                            <div id="success"></div>
                            <button id="sendMessageButton" class="btn btn-primary btn-xl text-uppercase" type="submit">Send Message<i class="fa fa-paper-plane-o ml-1"></i></button>
                          </div>
                      </div>
                       <!-- Form contact -->
                    </form>
