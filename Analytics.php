            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 sidebar fixed-top">
                        ...
                        <li class="nav-item" name="logout"><a href="index.php"
                                class="nav-link text-white p-3 mb-2 sidebar-link"><i
        ...
        <div class="container-fluid">
            <div class="row mb-5">
                <div class="col-xl-10 col-lg-9 col-md-9 ml-auto">
                    <div class="row">
                        <div class="col-12">
                            <h3 class="text-muted text-center mt-5 mb-3">Analytics</h3>
                            <div class="card shadow">
                                <div class="cardheader d-flex justify-content-between align-items-center">
                                    <h6 class="text-primary font-weight-bold m-0">Test Ratings</h6>
                                    <div class="dropdown no-arrow">
                                        ...
                                        <div class="dropdown-menu shadow dropdown-menu-right animated-fade-in"
                                            ...
                                            <a href="#" class="dropdown-item" role="presentation">Action</a>
                                            <a href="#" class="dropdown-item" role="presentation">Another Action</a>
                                            <div class="dropdown-divider"></div>
                                            <a href="#" class="dropdown-item" role="presentation">Something else
                                                here</a>
                                        </div>
                                    </div>
                                </div>
